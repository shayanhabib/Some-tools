...
$auth_users = array(
    ...
    'techowdy' => '$2y$10$cCEzRvWjtSAekmOmH2seuO47xVApyYJJw22z1g4Gj2Z/uspk3NBEO' //123@abc
);
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>TecHowdy</p>
                        <p><a href="mailto:hello@techowdy.com">hello@techowdy.com</a> </p>
                    </div>
                    <div class="col-xs-12 col-sm-6">
                        <div class="card">
...
<head>
    ...
    <meta name="author" content="TecHowdy">
